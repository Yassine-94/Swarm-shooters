...
# sys.path.append('/home/robot/Swarm/')
...
class Slave_Bot():
    def __init__(self):
        ...
        # self.df = pd.read_csv('datacsv')

        # self.y_data = df['distance']

        # self.x_data = df.drop('distance',axe=1)

        # self.LR = LinearRegression()
        # self.LR.fit(x_data,y_data)
    ...
    #     distance_estim = self.LR.predict([w,h])
    ...
    def pixy_camera(self):
        ...
        while True:
            ...
            if block[6]==2:
                ...
                dis = self.distance_calculations(w,h)
